...
//		System.out.println("luhong:usr.dir " + System.getProperty("user.dir"));
...
//		return Thread.currentThread().getContextClassLoader().getResource("").toString();
	...
	public static URL getExtendResource(String relativePath)
		...
		String classPathAbsolutePath = ClassLoaderUtil
				.getAbsolutePathOfClassLoaderClassPath().replaceAll("\\\\", "/");
		...
		System.out.println("luhong:resourceAbsolutePath" + resourceAbsolutePath);
		File file = new File(resourceAbsolutePath);
//		URL resourceAbsoluteURL = new URL(resourceAbsolutePath);
		URL resourceAbsoluteURL = file.toURL();
