...
//			}
			...
			System.out.println("luhonghere********2");
		} catch (Exception e) {
	...
	public void processProblem() {
		...
		System.out.println(this.vesGenerator == null ? "vesGeneratorEmpty" : "vesGeneratornotEmpty");
	...
	private static File getUMLResources() {
		try {
			...
			System.out.println("luhong" + fileURL.toString());
